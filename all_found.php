...
if (!empty($search_query)) {
    $sql .= " AND (item_name LIKE ? OR description LIKE ? OR location_found LIKE ?)";
    $params[] = "%$search_query%";
    $params[] = "%$search_query%";
    $params[] = "%$search_query%";
    $types .= "sss";
...
<head>
    ...
    <title>All Found Items - Lost & Found</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="all_found.php">Found Items</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <section class="page-header">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h1 class="display-5 fw-bold mb-3">All Found Items</h1>
                    <p class="lead mb-0">Browse through all reported found items</p>
                </div>
                <div class="col-md-4 text-md-end">
                    <a href="report_found.php" class="btn btn-light btn-lg">
            ...
            <div class="filter-section">
                <form method="GET" class="row g-3">
                    ...
                    <div class="col-md-2">
                        <label class="form-label">&nbsp;</label>
                        <div class="d-grid">
                            <a href="all_found.php" class="btn btn-outline-secondary">
    ...
    <section class="py-5">
        <div class="container">
            <div class="row mb-4">
                <div class="col-md-6">
                    <h4>Showing <?php echo $total_items; ?> found items</h4>
                </div>
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="mt-auto">
                                        ...
                                        <div class="d-grid mt-3">
                                            <a href="view_found.php?id=<?php echo $item['id']; ?>" class="btn btn-success">
            ...
            <?php else: ?>
                <div class="text-center py-5">
                    ...
                    <a href="all_found.php" class="btn btn-success">View All Items</a>
                </div>
            <?php endif; ?>
        </div>
    </section>
